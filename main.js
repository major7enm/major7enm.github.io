...
const i18nData = {
  ko: {
    ...
    popup_confirm: '확인',
    ceo_label: '대표이사',
    ceo_cred1: '서강대학교 언론대학원 석사',
    ceo_cred2: '음악 저작권 클리어런스 실무 16년 (2009~현재)',
    ceo_cred3: "'선재 업고 튀어' · '싱어게인' · '보이즈플래닛' 등 다수 프로그램 및 아티스트 콘텐츠 음악 저작권 총괄",
    ceo_cred4: "일간스포츠 칼럼 '김지욱 저작권썰.zip' 연재 중 · 2026 SMSA 강연",
    ceo_link: '칼럼 보러가기 ›',
    contact_phone_label: '대표 직통',
    contact_email_label: '공식 문의 메일',
    contact_office_label: '오피스',
  ...
  en: {
    ...
    ceo_label: 'CEO',
    ceo_cred1: 'M.A., Graduate School of Media & Communication, Sogang University',
    ceo_cred2: '16 years of music copyright clearance practice (2009–present)',
    ceo_cred3: "Music copyright lead for 'Lovely Runner', 'Sing Again', 'Boys Planet' and numerous programs & artist content",
    ceo_cred4: "Weekly copyright columnist for Ilgan Sports · Lecturer, 2026 SMSA",
    ceo_link: 'Read the column ›',
  ...
  ja: {
    ...
    popup_confirm: '確認',
    ceo_label: '代表取締役',
    ceo_cred1: '西江大学メディア＆コミュニケーション大学院 修士',
    ceo_cred2: '音楽著作権クリアランス実務16年（2009年～現在）',
    ceo_cred3: '『ソンジェ背負って走れ』『Sing Again』『BOYS PLANET』など多数の番組・アーティストコンテンツの音楽著作権を統括',
    ceo_cred4: '日刊スポーツにて著作権コラム連載中・2026 SMSA講演',
    ceo_link: 'コラムを読む ›',
    contact_phone_label: '代表直通',
    contact_email_label: '公式お問い合わせメール',
    contact_office_label: 'オフィス',
  ...
  zh: {
    ...
    popup_confirm: '确认',
    ceo_label: '代表理事',
    ceo_cred1: '西江大学传媒研究生院 硕士',
    ceo_cred2: '音乐版权许可实务16年（2009年至今）',
    ceo_cred3: '《背着善宰跑》《Sing Again》《BOYS PLANET》等多部节目及艺人内容的音乐版权总负责',
    ceo_cred4: '在《日刊体育》连载版权专栏 · 2026 SMSA讲座',
    ceo_link: '阅读专栏 ›',
    contact_phone_label: '代表直线',
    contact_email_label: '官方咨询邮箱',
    contact_office_label: '办公室',
    footer_privacy: '隐私政策',
    footer_terms: '使用条款',
  }
};
